...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('inventory', '0002_category_slug_product_slug_productimage_slug_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model', models.CharField(choices=[('ship', 'Ship'), ('train', 'Train'), ('truck', 'Truck'), ('aircraft', 'Aircraft')], max_length=255)),
        ...
        migrations.AddField(
            ...
            name='vehicle',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='inventory.vehicle'),
        ),
    ]
