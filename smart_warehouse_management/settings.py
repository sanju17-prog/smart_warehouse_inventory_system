"""
Django settings for smart_warehouse_management project.
...
SECRET_KEY = 'django-insecure-0#kb0@6bkrbyp!rw6*ui3ic(wppw_q!!ewf6v127$16=z7&ga_'
...
ROOT_URLCONF = 'smart_warehouse_management.urls'
...
WSGI_APPLICATION = 'smart_warehouse_management.wsgi.application'
...
JAZZMIN_SETTINGS = {
    ...
    "search_model": [
        "users.CustomUser",
        "inventory.Fleet",
    ],  # Allows searching in Students model
